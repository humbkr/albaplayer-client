...
const ShuffleBtn = (props, context) => {
  ...
  return (
    <Button {...props}>
      <svg width={size} height={size} viewBox="138 23 19 14" version="1.1" xmlns="http://www.w3.org/2000/svg">
