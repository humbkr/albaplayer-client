...
const RepeatBtn = (props, context) => {
  ...
  return (
    <Button {...props}>
      <svg width={size} height={size} viewBox="138 22 19 17" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g id="RepeatBtn" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" transform="translate(147.000000, 30.500000) scale(-1, 1) translate(-147.000000, -30.500000) translate(138.000000, 23.000000)">
          ...
          <text id="1" transform="translate(9.500000, 7.500000) scale(-1, 1) translate(-9.500000, -7.500000) " fontFamily="Roboto-Bold, Roboto" fontSize="7.5" fontWeight="bold" fill={`${context.color}`}>
